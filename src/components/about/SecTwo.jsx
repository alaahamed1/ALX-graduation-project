                ...
                <div className="py-12 md:py-20">
                    <div className="relative max-w-sm mx-auto grid gap-16 md:grid-cols-2 lg:grid-cols-3 lg:gap-y-20 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
                        <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <svg className="animate-pulse w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                <defs>
                            ...
                            <h3 className="h4 font-playfair-display mb-2">Mission</h3>
                            <p className="text-lg text-slate-500">To empower individuals to take control of their health by providing convenient and accessible healthcare services through an innovative digital platform.</p>
                        </div>
                        ...
                        <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
                            ...
                            <h3 className="h4 font-playfair-display mb-2">vision</h3>
                            <p className="text-lg text-slate-500">To be the leading provider of accessible, affordable, and high-quality healthcare solutions, transforming the way people experience and manage their health.</p>
                        </div>
                        ...
                        <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
                            ...
                            <h3 className="h4 font-playfair-display mb-2">Objectives</h3>
                            <p className="text-lg text-slate-500">Develop and maintain a user-friendly and secure platform for accessing healthcare services.<br />
                                Build a network of qualified and trusted healthcare professionals.</p>
                        </div>
                    </div>
                </div>
            </div>
