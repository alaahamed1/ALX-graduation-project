        ...
        <div className="py-12 md:py-20">
          <div className="relative max-w-3xl mx-auto text-center">
            <div className="relative">
              ...
              <p className="text-xl text-slate-200 mb-8">Personalized care tailored to your needs.</p>
              <div>
                <Link className="btn text-white bg-primary hover:bg-primaryLight group" to="/consult">
