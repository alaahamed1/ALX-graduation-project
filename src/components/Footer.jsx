...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-primaryDark ">
      <img className='absolute bg-cover filter brightness-50' src='../assets/images/building.png' alt='building footer pattern' loading='lazy' />
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          <div className="sm:col-span-12 lg:col-span-4 lg:max-w-xs">
            ...
            <div className="text-lg font-bold text-white">Connecting doctors and patients worldwide for quality healthcare.</div>
          </div>

          <div className="sm:col-span-6 md:col-span-4 lg:col-span-4">
            <h6 className="text-sm text-white font-semibold mb-2">Services</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-300 hover:text-secondaryDark transition duration-150 ease-in-out">Home Care Services</a>
              </li>
              <li>
                <a href="#" className="text-slate-300 hover:text-secondaryDark transition duration-150 ease-in-out">Online Medical Consultation</a>
              </li>
              <li>
                <a href="#" className="text-slate-300 hover:text-secondaryDark transition duration-150 ease-in-out">24/7 Doctor Chat Support</a>
              </li>
            </ul>
          </div>

          <div className="sm:col-span-6 md:col-span-4 lg:col-span-4">
            <h6 className="text-sm text-white font-semibold mb-2">Contact Us</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-300 hover:text-secondaryDark transition duration-150 ease-in-out">Email: support@MedifyCare.com</a>
              </li>
              <li>
                <a href="#" className="text-slate-300 hover:text-secondaryDark transition duration-150 ease-in-out">Phone: +1 234 567 890</a>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-6 md:py-8 border-t border-slate-200">
          ...
          <ul className="flex space-x-6 mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a className="text-secondaryDark hover:text-secondary transition duration-150 ease-in-out animate-spin" href="#0" aria-label="Twitter">
          ...
          <div className="text-sm text-slate-300 mr-4">© MedifyCare. All rights reserved.</div>
